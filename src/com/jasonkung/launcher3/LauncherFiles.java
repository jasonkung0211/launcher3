...
public class LauncherFiles {
    ...
    public static final String LAUNCHER_DB = "launcher<3.db";
    public static final String SHARED_PREFERENCES_KEY = "com.jasonkung.launcher3.prefs";
    public static final String WALLPAPER_CROP_PREFERENCES_KEY =
            "com.jasonkung.launcher3.WallpaperCropActivity";
    public static final String MANAGED_USER_PREFERENCES_KEY = "com.jasonkung.launcher3.managedusers.prefs";
